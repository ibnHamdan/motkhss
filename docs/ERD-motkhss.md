...
This document explores the design of motkhss, a social experience for find volunteers.
...
We'll use a relational database (schema follows) to fast retrieval of opportunities and
